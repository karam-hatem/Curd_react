            ...
            <div>
                ...
                <div className="row">
                    <table className="table table-striped table-bordered">
                        ...
                        <thead>
                    <button className="btn btn-primary" onClick={this.addUser}> Add User</button><br /><br />
                            <tr>
        ...
        this.state.users.map(
          user =>     
            <tr key={user.id}>
                    ...
                    <td> {user.email_id}</td>
                <td>
        <button onClick={() => this.editUser(user.id)} className="btn btn-warning"> Update </button>
