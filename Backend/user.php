<?php
    class User{
        ...
        public function createUser(){
            ...
            // $this->password_id=htmlspecialchars(strip_tags($this->password_id));
                   
            // bind data  //انتضار البيانات من المستخدم
            $stmt->bindParam(":first_name", $this->first_name);
            $stmt->bindParam(":last_name", $this->last_name);
            $stmt->bindParam(":email_id", $this->email_id);
            $stmt->bindParam(":password_id", $this->password_id);
       ...
       public function getSingleUser(){
        ...
        $this->password_id = $dataRow['password_id'];
